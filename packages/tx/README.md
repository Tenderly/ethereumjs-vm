...
const tx = Transaction.fromTxData(txParams, { chain: 'mainnet', hardfork: 'petersburg' })
tx.sign(privateKey)
...
The `Transaction` constructor receives a second parameter that lets you specify the chain and hardfork
